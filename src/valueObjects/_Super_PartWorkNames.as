 ...
 * of this value object you may modify the generated sub-class of this class - PartWorkNames.as.
 */
...
[ExcludeClass]
public class _Super_PartWorkNames extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _PartWorkNamesEntityMetadata;
     ...
     * properties
     */
    private var _internal_sequence : int;
    ...
    public function _Super_PartWorkNames()
    {
        _model = new _PartWorkNamesEntityMetadata(this);
    ...
    {
        var oldValue:int = _internal_sequence;
        if (oldValue !== value)
        {
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _PartWorkNamesEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _PartWorkNamesEntityMetadata) : void
    {
        var oldValue : _PartWorkNamesEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
