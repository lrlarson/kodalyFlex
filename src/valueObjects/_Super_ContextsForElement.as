 ...
 * of this value object you may modify the generated sub-class of this class - ContextsForElement.as.
 */
...
[ExcludeClass]
public class _Super_ContextsForElement extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _ContextsForElementEntityMetadata;
     ...
     * properties
     */
    private var _internal_elementSortIndex : int;
    ...
    public function _Super_ContextsForElement()
    {
        _model = new _ContextsForElementEntityMetadata(this);
    ...
    public function get elementSortIndex() : int
    {
        return _internal_elementSortIndex;
    }
    ...
    public function set elementSortIndex(value:int) : void
    {
        var oldValue:int = _internal_elementSortIndex;
        if (oldValue !== value)
        {
            _internal_elementSortIndex = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "elementSortIndex", oldValue, _internal_elementSortIndex));
        }
    }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _ContextsForElementEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _ContextsForElementEntityMetadata) : void
    {
        var oldValue : _ContextsForElementEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
