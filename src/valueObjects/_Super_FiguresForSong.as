 ...
 * of this value object you may modify the generated sub-class of this class - FiguresForSong.as.
 */
...
[ExcludeClass]
public class _Super_FiguresForSong extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _FiguresForSongEntityMetadata;
     ...
     * properties
     */
    private var _internal_Title_Key : int;
    private var _internal_Figure_Title_ID : int;
    ...
    public function _Super_FiguresForSong()
    {
        _model = new _FiguresForSongEntityMetadata(this);
    ...
    public function get Title_Key() : int
    {
        return _internal_Title_Key;
    }

    [Bindable(event="propertyChange")]
    public function get Figure_Title_ID() : int
    {
        return _internal_Figure_Title_ID;
    }
    ...
    public function set Title_Key(value:int) : void
    {
        var oldValue:int = _internal_Title_Key;
        if (oldValue !== value)
        {
            _internal_Title_Key = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "Title_Key", oldValue, _internal_Title_Key));
        }
    }

    public function set Figure_Title_ID(value:int) : void
    {
        var oldValue:int = _internal_Figure_Title_ID;
        if (oldValue !== value)
        {
            _internal_Figure_Title_ID = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "Figure_Title_ID", oldValue, _internal_Figure_Title_ID));
        }
    }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _FiguresForSongEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _FiguresForSongEntityMetadata) : void
    {
        var oldValue : _FiguresForSongEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
